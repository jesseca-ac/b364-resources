...
// Strategies are algorithms that are used for specific purposes. In this case authenticating the application using the Google API Console porject 0auth Client ID credentials
const GoogleStrategy = require('passport-google-oauth20').Strategy

// This configures Passport to use the Google OAuth 2.0 authentication strategy.
// Uses the Google API console project )OAuth Client ID Credentials(eg. clientID, clientSecret) to authorize the app to connect to the Google API.
...
// this returns the "profile" of the email used in the Google Login containing the user information (e.g. email, firstname, lastname)
